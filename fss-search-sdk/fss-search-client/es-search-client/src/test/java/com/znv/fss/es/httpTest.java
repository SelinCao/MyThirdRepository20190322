...
import com.znv.fss.es.FssPersonListGroup.FssPersonListGroup;
...
f3.add(f1);
    ...
    public static void fssHistoryCameraCount() {

      //  String params = "{'id':'13020','params':{'enter_time_start':'2019-03-14 00:00:00','enter_time_end':'2019-03-14 23:59:29','camera_id':['32010400001310007001'],'camera_aggregation':true,'camera_top_num':10}}";
        //'32010400001310007001'
        String params = "{'id':'13020','params':{'enter_time_start':'2019-03-14 00:00:00','enter_time_end':'2019-03-14 23:59:29','camera_id':['32010400001310007053','32010400001310007001'],'camera_top_num':10}}";
        JSONObject searchResult = null;
        long t = System.currentTimeMillis();
        try {
            BaseEsSearch search = EsManager.createSearch(params);
    ...
    public static void fssAlarmPersonList() {

        String params = "{'id':'13021','params':{'from':0,'size':2}}";
    ...
    public static void fssAlarmTopLibCount(){
        String params = "{'id':'13022','params':{'lib_id':['1','5'],'top':5}}";
...
/*        String params = "{'id':'13018','params':{'enter_time_start':'2018-09-18 00:00:00','enter_time_end':'2018-09-18 23:59:59','camera_id':[],'office_id':[],'lib_id':[1],'count_order':'desc','camera_aggregation':true,'similarity':0.92,'top':10}}";*/
        //按人员聚合
        String params = "{'id':'13018','params':{'enter_time_start':'2018-09-18 00:00:00','enter_time_end':'2018-09-18 23:59:59','camera_id':[],'office_id':[],'lib_id':[1],'count_order':'asc','person_aggregation':true,'lFThreshold':6,'hFThreshold':10,'similarity':0.92,'top':10}}";
        //人员轨迹
    ...
    public static void nightOutSearch() {
        ...
        //按人员聚合
        String params = "{'id':'13019','params':{'date_start':'2018-09-10','date_end':'2018-09-10'," +
                "'time_start':'21:00:00','time_end':'06:00:00','camera_id':['231'],'office_id':[]," +
                "'person_aggregation':true,'person_numbers':10,'frequency':40,'count_order':'asc'}}";
        //人员轨迹
      /*  String params = "{'id':'13019','params':{'date_start':'2019-02-19','date_end':'2019-02-19'," +
                "'time_start':'21:00:00','time_end':'06:00:00','person_size':100," +
                "'fused_id':['c104f79d-6296-4df1-a795-5c74eb66b0f1'],'trail_aggregation':true,'sort_order':'desc'}}";*/
        System.out.println(FormatObject.format(params));
    ...
    public static void main(String[] args) throws IOException {
       ...
       //String hostUrl = "hdfs://face.dct-znv.com:8020/user/fss/V120";
        ...
        try {
            EsManager.initConnection(hostUrl);
            while (true) {
                System.out.println("entering option: 0 -exit, 1 -arbitSearch, 2 -humSearch, 3-fastSearch,4-personlistSearch,5-personlistCount,6-historyPersonCount,7-alarmPersonCount,8-alarmTypeSearch,10-multiIndexExactSearch,11-multiIndexFastSearch,12-FssByTrailSearch,13-AbnormalRationSearch,14-AbnormalRationTrackSearch, 15-FssPersonListGroup,16-traceAnalysisSearch\n");
