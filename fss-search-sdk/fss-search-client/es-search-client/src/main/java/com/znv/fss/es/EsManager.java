...
import com.znv.fss.es.AbnormalBehaviorSearch.AbnormalBehaviorSearch;
...
import com.znv.fss.es.FssHistorySearch.FssHistorySearch;
import com.znv.fss.es.AbnormalRationSearch.AbnormalRationSearch;
import com.znv.fss.es.AbnormalRationTrackSearch.AbnormalRationTrackSearch;
import com.znv.fss.es.FssHomePageCount.FssAlarmPersonList;
import com.znv.fss.es.FssHomePageCount.FssAlarmTopLibCount;
import com.znv.fss.es.FssHomePageCount.FssHistoryCameraCount;
import com.znv.fss.es.FssNightOutSearch.NightOutSearch;
...
import com.znv.fss.es.TraceAnalysisSearch.TraceAnalysisSearch;
...
public class EsManager {
    ...
    private static String personListGroupTemplateName;
    private static String templateTraceAnalysisSearch;
    private static String templateHistoryCameraTakephCount;
    private static String templateNightOutSearch;
    private static String fssEsIndexNightHistoryName;
    private static String fssEsIndexNightHistoryType;
    ...
    public static void initConnection(String hostUrl) throws Exception {
        ...
        //personListGroupTemplateName = EsConfig.getProperty(VConstants.FSS_ES_SEARCH_TEMPLATE_PERSONLIST_GROUP_ID);
        ...
        // fssEsIndexNightHistoryName = "fused_src_data_nightowl-ct-2";
        fssEsIndexNightHistoryName = "fused_src_data_nightowl_02211";//"fused_src_data_nightowl";
        fssEsIndexNightHistoryType = "fused";
    ...
    public static String createPersonListURL() {
        return esServerIp + ":" + esHttpPort + "/" + indexPersonListName/*"person_list_data_v1_2"*/ + "/" + indexPersonListType+"/_search";
    }
            ...
            if (paramId.containsKey("id")) {
                ...
                if (sId == null) {
                    ...
                    if (EsConfig.getProperty() == null || hdfsFailed) {
                        ...
                        String esurl3=concatenateURL(fssEsIndexNightHistoryName,fssEsIndexNightHistoryType);

                        String esurl4 = insertURL(indexLogName, indexLogType);
                        String esurl5 = esServerIp + ":" + esHttpPort + "/" + indexAlarmName + "/" + indexAlarmType + "/_search";
                        switch (sId) {
...
//                                search = new WriteLogToEsBulkHttpPost(esurl4, indexLogName);
                            ...
                            case FssByTrailSearch:
                                ...
                                break;
                            case AbnormalRationSearch:
                                search =new AbnormalRationSearch(esurl,ariTemplateName);
                                break;
                            case FssHistorySearch:
                                search =new FssHistorySearch(esurl,ariTemplateName);
                                break;
                            case AbnormalRationTrackSearch:
                                search =new AbnormalRationTrackSearch(esurl,ariTemplateName);
                                break;
                            case AbnormalBehaviorSearch:
                                String ipAndPort = esServerIp + ":" + esHttpPort;
                                String indexNameAndType = fssEsIndexHistoryName + "/" + fssEsIndexHistoryType;
                                search = new AbnormalBehaviorSearch(ipAndPort, ariTemplateName, indexNameAndType);
                                break;
                            case FssPersonListGroup:
                                search = new FssPersonListGroup(esurl1, personListGroupTemplateName);
                                break;
                            case TraceAnalysisSearch:
                                search = new TraceAnalysisSearch(esurl, templateTraceAnalysisSearch);
                                break;
                            case NightOutSearch:
                                search = new NightOutSearch(esurl3, templateNightOutSearch);
                                break;
                            case FssHistoryCameraCount:
                                search = new FssHistoryCameraCount(esurl,templateHistoryCameraTakephCount);
                                break;
                            case FssAlarmPersonList:
                                search = new FssAlarmPersonList(esurl5);
                                break;
                            case FssAlarmTopLibCount:
                                search = new FssAlarmTopLibCount(esurl5);
                                break;
                            default:
                                LOG.info("查询的报表不存在。");
                                break;
    ...
    public enum SearchId {
        ...
        FssAlarmTypeSearch("告警事件检索", "13008"), LogInsert("日志写入", "13009"), MultiIndexExactSearch("多索引精确检索", "13010"), MultiIndexFastSearch("多索引极速检索", "13011"), FssByTrailSearch("轨迹查询", "13012"), AbnormalRationSearch("异常关系查询", "13013"),
        FssHistorySearch("历史库检索", "13014"), AbnormalRationTrackSearch("异常关系轨迹查询", "13015"),
        AbnormalBehaviorSearch("行为异常标签分析", "13016"), FssPersonListGroup("名单库列表统计", "13017"),TraceAnalysisSearch("行踪分析查询","13018"),NightOutSearch("频繁夜出查询", "13019"),FssHistoryCameraCount("看板历史摄像头抓拍统计","13020"),FssAlarmPersonList("看板告警列表显示","13021"),FssAlarmTopLibCount("看板告警库统计","13022");
        ...
        public static SearchId getSearchId(String id) {
            switch (id) {
                ...
                case "13013":
                    return  AbnormalRationSearch;
                case "13014":
                    return  FssHistorySearch;
                case "13015":
                    return AbnormalRationTrackSearch;
                case "13016":
                    return AbnormalBehaviorSearch;
                case "13017":
                    return FssPersonListGroup;
                case "13018":
                    return TraceAnalysisSearch;
                case "13019":
                    return NightOutSearch;
                case "13020":
                    return FssHistoryCameraCount;
                case "13021":
                    return FssAlarmPersonList;
                case "13022":
                    return FssAlarmTopLibCount;
                default:
                    break;
            }
            return null;
